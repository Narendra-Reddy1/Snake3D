...
namespace SnakeGame
{
    ...
    public enum EventID
    {
        ...
        EVENT_ON_TOGGLE_WAITING_FOR_PLAYERS_PANEL,
        REQUEST_TO_LOAD_MAIN_SCENE,
        EVENT_ON_MASTER_CLIENT_PROPERTIES_UPDATED,
        EVENT_ON_OPPONENT_PLAYER_PROPERTIES_UPDATED,
        REQUEST_NATIVE_ANDROID_ALERT,
    }
}